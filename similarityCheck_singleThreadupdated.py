...
def calculate_average_similarity_and_return_all(df1, df2):
    ...
    for i, (id, average_similarity_1,average_similarity_2, results_1, results_2) in enumerate(map(calculate_similarity, args)):
...
if __name__ == '__main__':
    ...
    print('reading data from fasta file...')
